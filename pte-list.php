        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">PTE Students</h1>
                </div>
            <?php 
                if(isset($_GET,$_GET['id']) && !empty($_GET['id'])){
                    ...
                    $sql1 = "SELECT * FROM pte WHERE cnum = '$cnum' ORDER BY testdate DESC";
            ...
            <div class="d-flex justify-content-end mb-4">
                <a href="pte-form.php?id=<?php echo $all_candidate['id'] ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Marks</a>
            </div> 
                            ...
                            while($row = mysqli_fetch_assoc($result1)){
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="pte.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
